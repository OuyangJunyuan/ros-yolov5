...
class yoloActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new yoloFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = yoloFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new yoloActionFeedback(null);
    ...
    data.feedback = yoloFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += yoloFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new yoloActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = yoloFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new yoloFeedback()
    }
...
module.exports = yoloActionFeedback;
